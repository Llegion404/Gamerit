/*
  # XP and Achievement System Functions

  1. Functions
    - `award_xp`: Awards XP to a player and handles level calculations
    - `check_achievements`: Checks and updates player achievements
    - `get_player_progression`: Gets player progression data

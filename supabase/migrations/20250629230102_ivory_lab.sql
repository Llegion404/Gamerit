/*
  # Fix Bet Leaderboard View

  1. Changes
    - Update bet_leaderboard view to use highest_bet_amount instead of total_bet_amount
    - Ensure the view is ordered by highest_bet_amount for proper leaderboard display
    - Keep all other statistics intact (win rate, total bets, etc.)
...
ORDER BY 
  highest_bet_amount DESC, total_winnings DESC, p.points DESC;

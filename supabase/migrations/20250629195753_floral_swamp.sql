/*
  ...
  1. Changes
    - Modify the bet_leaderboard view to better track betting activity
    - Add more detailed statistics about player betting behavior
    - Ensure proper sorting by total bet amount
*/
...
ORDER BY 
  total_bet_amount DESC, total_bets DESC, p.points DESC;

-- Add a comment to explain the view
COMMENT ON VIEW bet_leaderboard IS 'Comprehensive leaderboard of players ranked by their total bet amounts, with detailed betting statistics';